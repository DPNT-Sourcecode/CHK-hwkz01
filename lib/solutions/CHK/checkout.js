...
module.exports = function (skus) {
    ...
    pricing.set("H", [{promotionQuantity:1, promotionPrice:35}] );
    pricing.set("I", [{promotionQuantity:1, promotionPrice:60}] );
    pricing.set("J", [{promotionQuantity:1, promotionPrice:10}] );
    pricing.set("K", [{promotionQuantity:2, promotionPrice:150}, {promotionQuantity:1, promotionPrice:80}] );
    ...
    pricing.set("S", [{promotionQuantity:1, promotionPrice:30}] );
