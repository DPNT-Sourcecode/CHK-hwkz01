...
module.exports = function (skus) {
    ...
    pricing.set("G", [{promotionQuantity:1, promotionPrice:10}] );
    pricing.set("H", [{promotionQuantity:1, promotionPrice:10}] );
    pricing.set("I", [{promotionQuantity:1, promotionPrice:10}] );
    pricing.set("J", [{promotionQuantity:1, promotionPrice:10}] );
    pricing.set("K", [{promotionQuantity:1, promotionPrice:10}] );
    pricing.set("L", [{promotionQuantity:1, promotionPrice:10}] );
    pricing.set("M", [{promotionQuantity:1, promotionPrice:10}] );
    pricing.set("N", [{promotionQuantity:1, promotionPrice:10}] );
    pricing.set("O", [{promotionQuantity:1, promotionPrice:10}] );
    pricing.set("P", [{promotionQuantity:1, promotionPrice:10}] );
    pricing.set("Q", [{promotionQuantity:1, promotionPrice:10}] );
    pricing.set("R", [{promotionQuantity:1, promotionPrice:10}] );
    pricing.set("S", [{promotionQuantity:1, promotionPrice:10}] );
    pricing.set("T", [{promotionQuantity:1, promotionPrice:10}] );
    pricing.set("U", [{promotionQuantity:1, promotionPrice:10}] );
    pricing.set("V", [{promotionQuantity:1, promotionPrice:10}] );
    pricing.set("W", [{promotionQuantity:1, promotionPrice:10}] );
    pricing.set("X", [{promotionQuantity:1, promotionPrice:90}] );
    pricing.set("Y", [{promotionQuantity:1, promotionPrice:10}] );
    pricing.set("Z", [{promotionQuantity:1, promotionPrice:50}] );
